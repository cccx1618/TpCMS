...
<div class="place">
    ...
    <ul class="placeul">
        ...
        <li><a href="/index.php/role/add">添加角色</a></li>
    </ul>
</div>
...
<script>
    function submitadd(){
        ...
        $.post("/index.php/role/add",{'role_name':role_name,'role_info':role_info,'role_auth_ids':role_auth_ids,'role_auth_ca':role_auth_ca},function(data){
            if(data==1){
                showtip('添加角色成功');
                location.reload();
            }
