...
<div class="place">
    ...
    <ul class="placeul">
        <li><a href="/">首页</a></li>
        <li><a href="/index.php/role/index">角色管理</a></li>
    </ul>
</div>
...
<div class="rightinfo">
    ...
    <div class="tools">
        ...
        <ul class="toolbar">
            <li><a href="/index.php/role/add"><span><img src="/Public/Admin/images/t01.png" /></span>添加</a></li>
            <!--<li class="click"><span><img src="/Public/Admin/images/t02.png" /></span>修改</li>-->
            <!--<li onclick="showtip('确认批量删除吗？','/index.php/role/delete');"><span><img src="/Public/Admin/images/t03.png" /></span>批量删除</li>-->
    ...
    <table class="tablelist">
        ...
        <?php if(is_array($rolelist)): $i = 0; $__LIST__ = $rolelist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td><?php echo ($vo["role_info"]); ?></td>
                <td><?php if($vo['role_status'] == 1): ?>正常<?php else: ?><span style="color: red;">锁定</span><?php endif; ?></td>
                <td><a href="/index.php/role/edi/role_id/<?php echo ($vo["role_id"]); ?>" class="tablelink actionlink">修改</a>
                    &nbsp;|&nbsp;
                    <?php if($vo['role_status'] == 1): ?><a onclick="changestatus(<?php echo ($vo["role_id"]); ?>,<?php echo ($vo["role_status"]); ?>);" class="tablelink actionlink">锁定</a>
                        <?php else: ?>
                        <a onclick="changestatus(<?php echo ($vo["role_id"]); ?>,<?php echo ($vo["role_status"]); ?>);" class="tablelink actionlink">解锁</a><?php endif; ?>
                </td>
...
<script type="text/javascript">
    ...
    function changestatus(m,n){
        $.post('/index.php/role/changestatus',{'role_id':m,"role_status":n},function(data){
            if(data==1){
                showtip('操作成功');
                location.reload();
            }else{
